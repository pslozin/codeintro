...
let TotalSubscriptionCost = NetflixCost + HuluCost + DisneyCost + YouTubePremiumCost + PeacockCost;
...
HuluCost = HuluCost - 7;
PeacockCost = PeacockCost - 5;
NetflixCost = NetflixCost - 8;
...
let NewTotalSubscriptionCost = NetflixCost + HuluCost + DisneyCost + YouTubePremiumCost + PeacockCost;
...
console.log('Total: ', TotalSubscriptionCost)
console.log('New Total: ', NewTotalSubscriptionCost)
...
let NewSavings = (NewTotalSubscriptionCost * 100) /TotalSubscriptionCost;
